...
private:
	...
	*/
	...
	/*
	USAGE: Project the Oriented Bounding Box (OBB) onto the given axis.
	ARGUMENTS: The axis onto which the OBB is projected.
	OUTPUT: The interval length of the projection along the axis.
	*/
